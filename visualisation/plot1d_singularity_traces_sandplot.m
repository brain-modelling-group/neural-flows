function fig_handles = plot1d_singularity_traces_sandplot(params, varargin)
...
if params.singularity.quantification.nodal_occupancy.enabled
           fig_xyz_all_cp = plot1d_singularity_sandplot_nodal(obj_sings.tracking_2d_matrix, ...
                                                        obj_sings.locs, ...
                                                        base_list(1:8), ...
                                                        obj_sings.xyz_lims, ...
    ...
    switch to_plot
        ...
        case {'foci'}
            fig_xyz_base = plot1d_singularity_sandplot(obj_sings.classification_num, ...
        ...
        case {'saddles'}
            fig_xyz_saddles = plot1d_singularity_sandplot(obj_sings.classification_num, ...
                                                                     obj_sings.nullflow_points3d, ...
                                                                     cp_saddles, ...
                                                                     obj_sings.xyz_lims, ...
                                                                     marker_plot, fig_visibility{:});
        ...
        case {'orbits'}
            fig_xyz_po = plot1d_singularity_sandplot(obj_sings.classification_num, ...
                                                                obj_sings.nullflow_points3d, ...
                                                                base_list(9:14), ...
                                                                obj_sings.xyz_lims, ...
                                                                marker_plot, fig_visibility{:});
        ...
        case {'combined'}
           fig_xyz_all_cp = plot1d_singularity_sandplot(obj_sings.classification_num, ...
                                                                   obj_sings.nullflow_points3d, ...
                                                                   base_list(1:14), ...
                                                                   obj_sings.xyz_lims, ...
                                                                   marker_plot, fig_visibility{:});
        ...
        case {'all'}       
           ...
           % ORBITS
           fig_xyz_orbits = plot1d_singularity_sandplot(obj_sings.classification_num, ...   
                                                                   obj_sings.nullflow_points3d, ...
                                                                   base_list(9:14), ...
                                                                   obj_sings.xyz_lims, ...
                                                                   marker_plot, fig_visibility{:});
