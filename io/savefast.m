...
% savefast: fast saves of large (numeric) arrays to .mat files
% 
...
% Downloaded form Matlab's file-exchange / Copyright 2013 by Timothy E. Holy
%
% NOTES:
% https://undocumentedmatlab.com/blog/improving-save-performance
%
% PERFORMANCE:
% Saved a 67 x 67 x 400000 array in ~ 100s on a 5400RPM HDD
% Size in storage is ~14.5GB
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
