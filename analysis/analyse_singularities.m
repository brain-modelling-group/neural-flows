function fig_handles = plot_singularity_counts(params, varargin)
...
switch to_plot
    ...
    case {'foci'}
        fig_xyz_base = plot1d_singularity_scatter_xyz_vs_time(singularity_list_num, ...
    ...
    case {'saddles'}
        fig_xyz_saddles = plot1d_singularity_scatter_xyz_vs_time(singularity_list_num, ...
                                                                 obj_sings.nullflow_points3d, ...
                                                                 cp_saddles, ...
                                                                 options.interpolation.xyz_lims, ...
                                                                 marker_plot, fig_visibility{:});
    ...
    case {'orbits'}
        fig_xyz_po = plot1d_singularity_scatter_xyz_vs_time(singularity_list_num, ...
                                                            obj_sings.nullflow_points3d, ...
                                                            base_list(9:14), ...
                                                            options.interpolation.xyz_lims, ...
                                                            marker_plot, fig_visibility{:});
    ...
    case {'all'}
       ...
       % ORBITS
       fig_xyz_orbits = plot1d_singularity_scatter_xyz_vs_time(singularity_list_num, ...
                                                             obj_sings.null_points_3d, ...
                                                             base_list(9:14), ...
                                                             options.interpolation.xyz_lims, ...
                                                             marker_plot, fig_visibility{:});
