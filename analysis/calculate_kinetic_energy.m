...
min_duration_stable_state = params.data.resolution.ht * 30;
[stable, transient, stablePoints, transientPoints] = energy_states(energy_struct.component_sum_norm, time_vec, params.data.resolution.ht, min_duration_stable_state, extrema_detection, display_flag);
