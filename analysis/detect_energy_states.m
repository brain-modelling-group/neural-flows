function [stable, transient, stablePoints, transientPoints] = detect_energy_states(energy, time_vec, sampling_period, min_duration, extrema_detection, energy_mode, display_flag)
