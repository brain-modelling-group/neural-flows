...
% Original data bilbiographic reference:
% https://www.nature.com/articles/s41467-018-03399-2

% Experimental protocol: 
% We use the reference group of 33 adults, who watched a short, animated 
...
% Data:
% The data analysed in this function was processed as follows:
% 1)  parcellated 3D+t data, for one individual;
...
input_params_filename = 'fmri-waves_unstructured-amplitude-hs-meshbased_input.json';
