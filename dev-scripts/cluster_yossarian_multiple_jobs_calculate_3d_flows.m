function cluster_yossarian_multiple_jobs_calculate_3d_flows(idx_chunk)
% Script to process data on School of Physics Yossarian nodes

    load('/headnode2/paula123/Code/neural-flows/demo-data/long_cd_ictime50_seg7999_outdt1_d1ms_W_coupling0.6_trial1.mat', 'soln');
