function test_flows3d_estimation__travelling_biharmonic_wave_uac()
...
input_params = read_write_json('test-flows3d-estimation_biharmonic-wave_uac_in.json', 'json/', 'read');
